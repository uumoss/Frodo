...
#import "RATItleViewController.h"
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    RATItleViewController *recipeDetails = [RATItleViewController new];
    [self.navigationController pushViewController:recipeDetails animated:YES];
    recipeDetails.title = [self.dataSource titleAtIndexPath:indexPath];
